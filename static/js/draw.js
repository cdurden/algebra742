...
window.addEventListener('load', function () {
  ...
  function init () {
    ...
    document.body.addEventListener("touchmove", function (ev) { if (ev.target == canvas) { ev_canvas(ev); return false; } }, { passive: false }); }
    document.body.addEventListener("touchstart", function (ev) { if (ev.target == canvas) { ev_canvas(ev); return false; } }, { passive: false }); }
    document.body.addEventListener("touchend", function (ev) { if (ev.target == canvas) { ev_canvas(ev); return false; } }, { passive: false }); }
