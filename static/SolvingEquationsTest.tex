...
\begin{rubrictable}{4}
  ...
  \rubriccat{Solving Equations}{
    ...
    \rubricdesc{I can solve equations where a variable appears once in a simple sum or product. I can solve equations where a variable appears in a sum or product with both a constant and a coefficient.}{
    }
