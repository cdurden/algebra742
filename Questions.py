...
#        ],
#    },
    'MultiPartQuestionTest': {
        'ProvideImmediateFeedback': True,
        'Title': 'MultiPartQuestion Test', 
        'LearningGoal': r'\hrulefill \\ \hrulefill',
        'Questions': [
            {
    ...
    'LinearEquationsTest4Retry': {
        'ProvideImmediateFeedback': True,
        'Title': 'Linear Equations Test 4 Retry',
        'LearningGoal': r'\hrulefill \\ \hrulefill',
        'Questions': [
            {
            ...
            'ParameterSetVariants': [
                {'variables': ['x','y'],
                    'Question': r'Write an equation of the line through the point $(-4,-1)$ with slope $4$.',
                    'x': [-2,0],
                    'y': [1,4],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                    'grid_y': json.dumps([x[1] for x in gen_grid(-15,15,-20,20,1,1)]),
                    'show_points': False,
                    'hide_line': False,
                    'N': json.dumps(2),
                    'dtickx': json.dumps(1),
                ...
                {'variables': ['x','y'],
                    'Question': 'Write an equation of the line through the points $(-4,3)$ and $(8,-1)$',
                    'x': [-4,8],
                    'y': [3,-1],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                    ...
                    'dtickx': json.dumps(1),
                    'dticky': json.dumps(1),
                    'equation': 'y-3=-1/4(x+4)',
                    'draw': True,
                },
                {'variables': ['x','y'],
                    'Question': 'Write an equation of the line through the point $(1,2)$ with slope $0$. Write the equation in slope-intercept form, and simplify it completely.',
                    'x': [1,5],
                    'y': [2,2],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                ...
                {'variables': ['x','y'],
                    'Question': 'Write an equation of the line through the points $(-1,5)$ and $(3,8)$',
                    'x': [-1,3],
                    'y': [-5,8],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
            ...
            'ParameterSetVariants': [
                {'variables': ['x','y'],
                 'Question': r'The line through the points $(-1,0)$ and $(5,4)$ is shown in the graph. Write an equation of a line parallel to this line that passes through the point $(2,3)$.',
                    'x': [-1,5],
                    'y': [0,4],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                ...
                {'variables': ['x','y'],
                 'Question': r'The line given by the equation $y=\frac{4}{5}x+1$ is shown in the graph below. Write an equation of the line through the point $(2,0)$ and parallel to this line.',
                    'x': [0,4],
                    'y': [2,5],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                ...
                {'variables': ['x','y'],
                 'Question': r'The line given by the equation $y=\frac{4}{5}x+1$ is shown in the graph below. Write an equation of the line through the point $(2,0)$ and perpendicular to this line.',
                    'x': [0,4],
                    'y': [2,5],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
            ...
            'ParameterSetVariants': [
                {'variables': ['x','y'],
                    'Question': 'Write an equation of the line through the point $(2,7)$ with undefined slope.',
                    'x': [2,2],
                    'y': [7,-7],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
            ...
            },
            {
                ...
                'ParameterSetVariants': [
                    {'variables': ['x','y'],
                     'Question': 'Write an equation of the line through the points $(-2,-1)$ and $(3,-1)$',
                        'x': [-2,3],
                        'y': [-1,-1],
                        'labels': ['A','B'],
                        'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Write an equation of the line through the points $(8,7)$ and $(8,-1)$',
                        'x': [8,8],
                        'y': [7,-1],
                        'labels': ['A','B'],
                        'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $y+1=3(x+3)$ in slope-intercept form.',
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $y+2=2(x-3)$ in standard form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $-3x+12=6y$ in standard form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $12x+6y=24$ in slope-intercept form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
    ...
    'LinearEquationsTest4RetryPractice': {
        'ProvideImmediateFeedback': True,
        'Title': 'Linear Equations Test 4 Retry Practice Assignment',
        'LearningGoal': r'\hrulefill \\ \hrulefill',
        'Questions': [
            {
            'Type': 'EquivalentEquation',
            ...
            'ParameterSetVariants': [
                {'variables': ['x','y'],
                    'Question': r'Write an equation of the line through the point $(-2,1)$ with slope $\frac{3}{2}$.',
                    'x': [-2,0],
                    'y': [1,4],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                ...
                {'variables': ['x','y'],
                    'Question': 'Write an equation of the line through the points $(0,4)$ and $(5,-2)$',
                    'x': [0,5],
                    'y': [4,-2],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                ...
                {'variables': ['x','y'],
                    'Question': 'Write an equation of the line through the points $(-1,-3)$ and $(4,1)$',
                    'x': [-1,4],
                    'y': [-3,1],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
            ...
            'ParameterSetVariants': [
                {'variables': ['x','y'],
                 'Question': r'The line through the points $(1,0)$ and $(5,6)$ is shown in the graph. Write an equation of a line parallel to this line that passes through the point $(1,3)$.',
                    'x': [1,5],
                    'y': [0,6],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                ...
                {'variables': ['x','y'],
                 'Question': r'The line given by the equation $y=\frac{3}{4}x+2$ is shown in the graph below. Write an equation of the line through the point $(-1,-3)$ and parallel to this line.',
                    'x': [0,4],
                    'y': [2,5],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                    ...
                    'dtickx': json.dumps(1),
                    'dticky': json.dumps(1),
                    'equation': 'y+3=3/4*(x+1)',
                    'rhs': '3/4*x+2',
                    'draw': True,
                },
                {'variables': ['x','y'],
                 'Question': r'The line given by the equation $y=\frac{3}{4}x+2$ is shown in the graph below. Write an equation of the line through the point $(-1,-3)$ and perpendicular to this line.',
                    'x': [0,4],
                    'y': [2,5],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
            ...
            'ParameterSetVariants': [
                {'variables': ['x','y'],
                    'Question': 'Write an equation of the line through the point $(-3,-5)$ with undefined slope.',
                    'x': [-3,-5],
                    'y': [-3,-8],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
            ...
            },
            {
                ...
                'ParameterSetVariants': [
                    {'variables': ['x','y'],
                     'Question': 'Write an equation of the line through the points $(-1,-4)$ and $(6,-4)$',
                        'x': [-1,6],
                        'y': [-4,-4],
                        'labels': ['A','B'],
                        'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Write an equation of the line through the points $(5,3)$ and $(5,-5)$',
                        'x': [5,5],
                        'y': [3,-5],
                        'labels': ['A','B'],
                        'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $y-5=2(x+3)$ in slope-intercept form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $y-11=7(x-3)$ in standard form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $4x-12=2y$ in standard form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $4x+5y=20$ in slope-intercept form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
    ...
    'CostOfDrivingProject': {
        'ProvideImmediateFeedback': True,
        'Title': 'February 21: Cost of Driving Project Car Choice',
        'Questions': [
            {
            'Type': 'CarChoice',
            'Template': 'CarChoice.html',
            #'Template': 'Grid.tex',
            'ParameterSetVariants': [
                {'x': [None,0], 'y': [0,None], 'variables': ['x','y'],
                 'question': 'Enter the make, model, price, and gas mileage of the car you chose below.',
                    #'draw': True,
    ...
    'FlagProject': {
        'ProvideImmediateFeedback': True,
        'Title': 'February 21: Flag Project Submission Form',
        'Questions': [
            {
            'Type': 'OpenResponse',
            ...
            'ParameterSetVariants': [
                {'x': [None,0], 'y': [0,None], 'variables': ['x','y'],
                 'question': 'Open your flag project in Desmos, click the share button to copy the link to your clipboard and paste the link into the box below. Then click submit.',
                    #'draw': True,
                    'no_answer': json.dumps(True),
                },
                ],
    ...
    'LinearEquationsTest4': {
        'ProvideImmediateFeedback': True,
        'Title': 'Linear Equations Test 4',
        'LearningGoal': r'\hrulefill \\ \hrulefill',
        'Questions': [
            {
            'Type': 'EquivalentEquation',
            ...
            'ParameterSetVariants': [
                {'variables': ['x','y'],
                    'Question': 'Write an equation of the line through the point $(-4,4)$ with slope $3$.',
                    'x': [-8,-3],
                    'y': [-8,7],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                ...
                {'variables': ['x','y'],
                    'Question': 'Write an equation of the line through the points $(0,-4)$ and $(8,-6)$',
                    'x': [-8,8],
                    'y': [-2,-6],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                    ...
                    'dtickx': json.dumps(1),
                    'dticky': json.dumps(1),
                    'equation': 'y+2=-1/4(x+8)',
                    'draw': True,
                },
                {'variables': ['x','y'],
                    'Question': 'Write an equation of the line through the point $(2,3)$ with slope $0$. Write the equation in slope-intercept form, and simplify it completely.',
                    'x': [-8,3],
                    'y': [8,3],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                ...
                {'variables': ['x','y'],
                    'Question': 'Write an equation of the line through the points $(2,-5)$ and $(4,5)$',
                    'x': [2,4],
                    'y': [-5,5],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
            ...
            'ParameterSetVariants': [
                {'variables': ['x','y'],
                 'Question': r'The line through the points $(1,0)$ and $(7,7)$ is shown in the graph. Write an equation of a line parallel to this line that passes through the point $(1,-1)$.',
                    'x': [1,7],
                    'y': [0,7],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                ...
                {'variables': ['x','y'],
                 'Question': r'The line given by the equation $y=-\frac{2}{5}x+6$ is shown in the graph below. Write an equation of the line through the point $(3,0)$ and parallel to this line.',
                    'x': [0,5],
                    'y': [6,5],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                ...
                {'variables': ['x','y'],
                 'Question': r'The line given by the equation $y=-\frac{2}{5}x+6$ is shown in the graph below. Write an equation of the line through the point $(2,3)$ and perpendicular to this line.',
                    'x': [0,5],
                    'y': [6,5],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
            ...
            'ParameterSetVariants': [
                {'variables': ['x','y'],
                    'Question': 'Write an equation of the line through the point $(3,6)$ with undefined slope.',
                    'x': [4,3],
                    'y': [-4,-1],
                    'labels': ['A','B'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
            ...
            },
            {
                ...
                'ParameterSetVariants': [
                    {'variables': ['x','y'],
                     'Question': 'Write an equation of the line through the points $(-1,-5)$ and $(8,-5)$',
                        'x': [-1,-5],
                        'y': [8,-5],
                        'labels': ['A','B'],
                        'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Write an equation of the line through the points $(-2,3)$ and $(-2,-5)$',
                        'x': [-2,-2],
                        'y': [3,-5],
                        'labels': ['A','B'],
                        'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $y+7=2(x+8)$ in slope-intercept form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $y+5=-7(x-2)$ in standard form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $2x-10=2y$ in standard form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $2x+3y=6$ in slope-intercept form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
    ...
    'Feb19CW': {
        'ProvideImmediateFeedback': True,
        'Title': 'Feb 19: Practice for Test 4',
        'LearningGoal': r'\hrulefill \\ \hrulefill',
        'Questions': [
            {
            'Type': 'EquivalentEquation',
            ...
            'ParameterSetVariants': [
                {'variables': ['x','y'],
                 'Question': 'Write an equation of the line through the points $(14,12)$ and $(-18,-9)$',
                    'x': [14,-18],
                    'y': [12,-9],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                    'grid_y': json.dumps([x[1] for x in gen_grid(-15,15,-20,20,1,1)]),
                    ...
                    'dtickx': json.dumps(1),
                    'dticky': json.dumps(1),
                    'equation': 'y-12=21/32(x-14)',
                    'draw': True,
                },
                {'variables': ['x','y'],
                 'Question': 'Write an equation of the line parallel to the given line through the point $(0,-3)$.',
                    'x': [14,-18],
                    'y': [12,-9],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                    'grid_y': json.dumps([x[1] for x in gen_grid(-15,15,-20,20,1,1)]),
                ...
                {'variables': ['x','y'],
                 'Question': 'Write an equation of the line perpendicular to the given line through the point $(0,-3)$.',
                    'x': [14,-18],
                    'y': [12,-9],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                    'grid_y': json.dumps([x[1] for x in gen_grid(-15,15,-20,20,1,1)]),
            ...
            },
            {
                ...
                'ParameterSetVariants': [
                    {'variables': ['x','y'],
                     'Question': 'Write an equation of the line through the points $(-18,10)$ and $(-18,-10)$',
                        'x': [-18,-18],
                        'y': [10,-10],
                        'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-15,15,-20,20,1,1)]),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Write an equation of the line through the points $(-18,-12)$ and $(18,-12)$',
                        'x': [-18,18],
                        'y': [-12,-12],
                        'grid_x': json.dumps([x[0] for x in gen_grid(-15,15,-20,20,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-15,15,-20,20,1,1)]),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $2y-10=2x$ in standard form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $y+3=21/32x$ in point-slope form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
    ...
    'Feb18HW': {
        'ProvideImmediateFeedback': True,
        'Title': 'Feb 18 HW: Write equations for horizontal and vertical lines',
        'LearningGoal': r'\hrulefill \\ \hrulefill',
        'Questions': [
            {
                'Type': 'Equation',
                ...
                'ParameterSetVariants': [
                    {'variables': ['x','y'],
                     'Question': 'Write an equation for the line through the points $(-4,-4)$ and $(2,-4)$.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
         ...
         #   'Template': 'Question.html',
            ...
            'ParameterSetVariants': [
                {'variables': ['x','y'],
                 'Question': 'Write an equation of the line through the points $(0,6)$ and $(2,10)$.',
                    'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                    'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                    'N': json.dumps(2),
                    'dtickx': json.dumps(1),
            ...
            'ParameterSetVariants': [
                {
                 'Question': 'Find the 100th term of the arithmetic sequence $(5,8,11,14, \ldots)$.',
    ...
    'Feb18CW': {
        ...
        'Questions': [
            ...
            'ParameterSetVariants': [
                {'variables': ['x','y'],
                 'Question': 'Write an equation of the line parallel to the given line through the point $(0,5)$.',
                    'x': [0,3],
                    'y': [8,2],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                    'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                ...
                {'variables': ['x','y'],
                 'Question': 'Write an equation of the line perpendicular to the given line through the point $(0,5)$.',
                    'x': [0,3],
                    'y': [8,2],
                    'show_points': True,
                    'hide_line': False,
                ...
                {'variables': ['x','y'],
                 'Question': r'Write an equation of the line parallel to the given line through the point $(1,5)$.',
                    'x': [4,-3],
                    'y': [5,8],
                    'show_points': True,
                    'hide_line': False,
                    ...
                    'dtickx': json.dumps(1),
                    'dticky': json.dumps(1),
                    'equation': 'y-5=-3/7(x-1)',
                    'draw': True,
                },
                {'variables': ['x','y'],
                 'Question': r'Write an equation of the line perpendicular to the given line through the point $(1,5)$.',
                    'x': [4,-3],
                    'y': [5,8],
                    'show_points': True,
                    'hide_line': False,
                    'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-10,15,1,1)]),
                    'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-10,15,1,1)]),
                    'N': json.dumps(2),
                    'dtickx': json.dumps(1),
                    'dticky': json.dumps(1),
                    'equation': 'y-5=7/3(x-1)',
                    'draw': True,
                },
                {'variables': ['x','y'],
                 'Question': 'Write an equation of the line parallel to the given line through the point $(3,-4)$',
                    'x': [5,-1],
                    'y': [7,3],
                    'show_points': True,
                    'hide_line': False,
                    ...
                    'dtickx': json.dumps(1),
                    'dticky': json.dumps(1),
                    'equation': 'y+4=2/3(x-3)',
                    'draw': True,
                },
                {'variables': ['x','y'],
                 'Question': 'Write an equation of the line perpendicular to the given line through the point $(3,-4)$',
                    'x': [5,-1],
                    'y': [7,3],
                    'show_points': True,
                    'hide_line': False,
                ...
                {'variables': ['x','y'],
                 'Question': 'Write an equation of the line parallel to the given line through the point $(0,2)$.',
                    'x': [-1,7],
                    'y': [8,-2],
                    'show_points': True,
                    'hide_line': False,
                ...
                {'variables': ['x','y'],
                 'Question': 'Write an equation of the line perpendicular to the given line through the point $(0,2)$.',
                    'x': [-1,7],
                    'y': [8,-2],
                    'show_points': True,
                    'hide_line': False,
    ...
    'Feb12HW': {
        'ProvideImmediateFeedback': True,
        'Title': 'Feb 12 HW: Write equations for horizontal and vertical lines',
        'LearningGoal': r'\hrulefill \\ \hrulefill',
        'Questions': [
            {
                'Type': 'Equation',
                ...
                'ParameterSetVariants': [
                    {'variables': ['x','y'],
                     'Question': 'Write an equation for the line through the points $(-4,5)$ and $(2,5)$.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Write an equation for the line through the points $(3,-9)$ and $(3,4)$.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Write an equation for the line through the points $(-2,5)$ and $(-2,10)$.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Write an equation for the line through the points $(-4,-7)$ and $(-6,-7)$.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
    ...
    'Feb10HW': {
        'ProvideImmediateFeedback': True,
        'Title': 'Feb 10 HW: Rewrite equations in slope-intercept and standard form',
        'LearningGoal': r'\hrulefill \\ \hrulefill',
        'Questions': [
            {
                'Type': 'Equation',
                ...
                'ParameterSetVariants': [
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $y+5=x-2$ in standard form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $y-1=4(x-3)$ in standard form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
                    ...
                    {'variables': ['x','y'],
                     'Question': r'Rewrite the equation $y+2=\frac{1}{2}(x-6)$ in slope-intercept form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
        ...
        'Questions': [
                ...
                'ParameterSetVariants': [
                    {
                        ...
                        'choices': [
                            ('a', 'Distribute.'),
                            ('b', 'Eliminate a constant from the LHS'),
                            ('c', 'Eliminate a constant from the RHS'),
                            ('d', 'Eliminate $x$ from the LHS'),
                            ('e', 'Eliminate $x$ from the RHS'),
                            ('f', 'Eliminate $y$ from the LHS'),
                            ('g', 'Eliminate $y$ from the RHS'),
                    ...
                    {
                        'Question': "What steps would you take to rewrite the equation $2x-5 = 3y-2$ in standard form? Select all that apply.",
                        'image': None,
                        'choices': [
                            ('a', 'Distribute.'),
                            ('b', 'Eliminate a constant from the LHS'),
            ...
            },
            {
                ...
                'ParameterSetVariants': [
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $y-1=3(x+5)$ in standard form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
            ...
            },
            {
                ...
                'ParameterSetVariants': [
                    ...
                    {
                        'Question': "What steps would you take to rewrite the equation $y-5 = 3(x-2)$ in standard form? Select all that apply.",
                        'image': None,
                        'choices': [
                            ('a', 'Distribute.'),
                            ('b', 'Eliminate a constant from the LHS'),
            ...
            },
            {
                ...
                'ParameterSetVariants': [
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $y-4=2(x-2)$ in slope-intercept form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
                    ...
                    {'variables': ['x','y'],
                     'Question': 'Rewrite the equation $y+4=2(x-3)$ in standard form.',
                        'grid_x': json.dumps([x[0] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'grid_y': json.dumps([x[1] for x in gen_grid(-5,10,-5,10,1,1)]),
                        'N': json.dumps(2),
                        'dtickx': json.dumps(1),
