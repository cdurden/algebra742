...
#            },
            ...
            'Template': 'PlotQuestion.html',
            'ParameterSetVariants': [
                {'question': r'An amusement part charges \$50 for admission before 6 PM, and \$20 for admission after 6 PM. On Saturday, the park took in a total of \$20,000. Let $x$ be the admissions sold before 6 PM, and let $y$ be the admissions sold after 6 PM. Fill in the table with possible numbers of admissions, and graph the relationship. Then explain what the $x$ and $y$-intercepts mean.', 'x': [None,0], 'y': [0,None], 'variables': ['x','y'],
                    'grid_x': json.dumps([x[0] for x in gen_grid(-1,14,-1,14,1,1)]),
                    'grid_y': json.dumps([x[1] for x in gen_grid(-1,14,-1,14,1,1)]),
                    'N': json.dumps(2),
                    'dtickx': json.dumps(1),
