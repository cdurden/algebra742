    ...
    'FlexibleLearningSimulation': {
        ...
        'Questions': [
            ...
            'ParameterSetVariants': [
                {'question': '<b>Directions:</b> Click the radio button below, and enter your name in the textbox to be marked present for today\'s Algebra flexible learning day simulation. Then answer questions 2-4 in this assignment and submit your answers. <br/><b>Note:</b> Questions 2 and 4 contain videos that you can use to get help on those questions. You will need to close this Schoology window and then re-open Algebra742 a second time in order to access the videos.',
                    'Choices': [('Present', 'I am present, and I have read the information above.')],
                    'other': 'Your name',
            ...
            'ParameterSetVariants': [
                ...
                {'Question': r'Write the equation $2y-3=4x+9$ in standard form. Fill in the $x$ and $y$-intercepts in the table. Then graph the relationship.', 'x': [None,0], 'y': [0,None], 'variables': ['x','y'],
                    ...
                    'equation': '2y-3=4x+9',
                    'draw': True,
                    'html': '<p>Watch the video for help with this problem. <br/><b>Important Note:</b>You will need to close this window in Schoology and re-open Algebra742 a second time to get the video to play.</p><div class="video_iframe"><iframe width="560" height="315" src="https://www.youtube.com/embed/nnmzjEJM-tA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>',
                },
                ],
            'SpaceAfter': '4cm',
            },
