QuestionSets = {
    ...
    'SolveEquationsGuided': {
        ...
        [
            ...
            'ParameterSetVariants': [
                {'equation': r'2x+15=83', 'variables': r'x'}, 
                {'equation': r'1/4(x+2)=10', 'variables': r'x'},
                {'equation': r'2/3x+10=31', 'variables': r'x'},
                {'equation': r'1/5(x+5)=10', 'variables': r'x'},
                {'equation': r'3x+-3=30', 'variables': r'x'},
                {'equation': r'1/3(x+-3)=10', 'variables': r'x'},
                {'equation': r'2/3(x+12)=10', 'variables': r'x'},
                {'equation': r'5/6x+10=20', 'variables': r'x'},
                {'equation': r'-3/4x+6=9', 'variables': r'x'},
                {'equation': r'2/5(x-10)=20', 'variables': r'x'},
                {'equation': r'-3/8x-5=9', 'variables': r'x'},
                {'equation': r'(x-5)/3=9', 'variables': r'x'},
                {'equation': r'-2x-5=9-x', 'variables': r'x'},
                {'equation': r'(x-5)/3=2x+1', 'variables': r'x'},
                ],
            'SpaceAfter': '4cm',
            }
        ]
