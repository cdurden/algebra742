    ...
    'FindXAndYInterceptsAndPredict': {
        ...
        'Questions': [
            ...
            'ParameterSetVariants': [
                ...
                {'question': 'Graph the equation $3x+6y=18$. Then predict the value of $y$ when $x=3$',
                    'x': json.dumps([x[0] for x in grid]),
                    'y': json.dumps([x[1] for x in grid]),
                    'N': json.dumps(2),
                    'variables': ['x','y'],
                ...
                {'question': 'Graph the equation $2x+4y=20$. Then predict the value of $y$ when $x=5$.',
                    'x': json.dumps([x[0] for x in grid]),
                    'y': json.dumps([x[1] for x in grid]),
                    'N': json.dumps(2),
                    'variables': ['x','y'],
                ...
                {'question': 'Graph the equation $5x+3y=30$. Then predict the value of $y$ when $x=2$',
                    'x': json.dumps([x[0] for x in grid]),
                    'y': json.dumps([x[1] for x in grid]),
                    'N': json.dumps(2),
                    'variables': ['x','y'],
                ...
                {'question': 'Graph the equation $2x+y=10$. Then predict the value of $y$ when $x=20$',
                    'x': json.dumps([x[0] for x in grid]),
                    'y': json.dumps([x[1] for x in grid]),
                    'N': json.dumps(2),
                    'variables': ['x','y'],
                ...
                {'question': 'Graph the equation $2x+4y=8$. Then predict the value of $y$ when $x=15$',
                    'x': json.dumps([x[0] for x in grid]),
                    'y': json.dumps([x[1] for x in grid]),
                    'N': json.dumps(2),
                    'variables': ['x','y'],
                ...
                {'question': 'Graph the equation $x+y=-2$. Then predict the value of $y$ when $x=2$',
                    'x': json.dumps([x[0] for x in grid]),
                    'y': json.dumps([x[1] for x in grid]),
                    'N': json.dumps(2),
                    'variables': ['x','y'],
                ...
                {'question': 'Graph the equation $5x-y=10$. Then predict the value of $y$ when $x=1$',
                    'x': json.dumps([x[0] for x in grid]),
                    'y': json.dumps([x[1] for x in grid]),
                    'N': json.dumps(2),
                    'variables': ['x','y'],
