    ...
    'FlexibleLearningSimulation': {
        ...
        'Questions': [
            ...
            'ParameterSetVariants': [
                {'question': r'Write the equation $y=2x+8$ in standard form. Fill in the $x$ and $y$-intercepts in the the table. Then graph the relationship.', 'x': [None,0], 'y': [0,None], 'variables': ['x','y'],
