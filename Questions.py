        ...
        'Questions': [
            ...
            'ParameterSetVariants': [
                {'x': [None,0], 'y': [0,None], 'variables': ['x','y'],
                 'Question': 'Graph the equation ${:s}$.'.format('3x+5=-10'),
                    ...
                    'equation': '3x+5=-10',
                    'draw': True,
                    'html': '<p>Watch the video for help with this problem. <br/><b>Important Note:</b>You will need to close this window in Schoology and re-open Algebra742 a second time to get the video to play. If you cannot get the video to work in this page, use this <a href="https://youtu.be/vPwv5J3n9Jc">link.</a></p><div class="video_iframe"><iframe width="560" height="315" src="https://www.youtube.com/embed/vPwv5J3n9Jc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>',
                },
                ],
            'SpaceAfter': '0cm',
            },
            ...
            'ParameterSetVariants': [
                {'x': [None,None], 'y': [None,None], 'variables': ['x','y'],
                    ...
                    'equation': '4y=2x+2',
                    'draw': True,
                    'html': '<p>Watch the video for help with this problem. <br/><b>Important Note:</b>You will need to close this window in Schoology and re-open Algebra742 a second time to get the video to play. If you cannot get the video to work in this page, use this <a href="https://youtu.be/uwekVduXnh4">link.</a></p><div class="video_iframe"><iframe width="560" height="315" src="https://youtu.be/uwekVduXnh4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>',
                },
                ],
            'SpaceAfter': '4cm',
            },
