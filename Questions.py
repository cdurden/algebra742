...
#            },
                {
                'Question': r'The population of Bay Village is 35,000 today. Every year the population of Bay Village increases by 750 people.',
                ...
                {
                'Question': r'Conner has \$25,000 in his bank account. Every month he spends \$1,500. He does not add money to the account.',
                ...
                {
                'Question': r'A cell phone plan costs \$30 per month for unlimited calling plus \$0.15 per text message.',
                'equation': 'y=30+0.15x',
                    'draw': True,
                    'grid_x': json.dumps([x[0] for x in gen_grid(-1,100,0,30,1,0.15)]),
                    'grid_y': json.dumps([x[1] for x in gen_grid(-1,100,0,30,1,0.15)]),
                    'show_points': False,
                    'hide_line': False,
...
#            },
                ...
                'equation': 'y=30+0.15x',
                    'draw': True,
                    'grid_x': json.dumps([x[0] for x in gen_grid(-1,12,0,30,1,0.05)]),
                    'grid_y': json.dumps([x[1] for x in gen_grid(-1,12,0,30,1,0.05)]),
                    'show_points': False,
                    'hide_line': False,
                    'dtickx': json.dumps(1),
                    'dticky': json.dumps(0.05),
                    'N': json.dumps(2),
                },
                {
                'Question': r'A salesperson receives a base salary of \$35,000 and a commission of 10% of the total sales for the year.',
