...
class Sort(Question):
    def scripts(self):
        ...
        return(['https://code.jquery.com/jquery-1.12.4.js', 'https://raw.githack.com/SortableJS/Sortable/master/Sortable.js', 'https://cdn.jsdelivr.net/npm/jquery-sortablejs@latest/jquery-sortable.js'])
